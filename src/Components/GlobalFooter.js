export default function Footer() {
 ...
 <footer aria-labelledby="footer-extras" className="footer vcard v22" id="csus-global-footer">
    <div className="container-fluid">
      ...
      <div className="row">
        <h3 aria-hidden="true" className="d-none" id="campus-social-links">
          Campus-Wide Social Media Navigation
        </h3>
        <ul
          aria-labelledby="campus-social-links"
          className="list-inline text-center col-md-4 order-md-2"
        >
          {/* Removed IDs for icons in favor of `a[href=*"twitter"]` etc */}
          <li>
            <a className="url uid" href="https://twitter.com/sacstate">
              Visit Sac State at Twitter
            </a>
          </li>
          <li>
            <a className="url uid" href="https://www.facebook.com/sacstate">
              Visit Sac State at Facebook
            </a>
          </li>
          <li>
            <a className="url uid" href="https://www.instagram.com/sacstate">
              Visit Sac State at Instagram
            </a>
          </li>
          <li>
            <a href="https://www.linkedin.com/school/sacstate">
          ...
          <li>
            <a
              className="url uid"
              href="https://www.flickr.com/photos/sacstate"
            >
              Visit Sac State at Flickr
            </a>
          </li>
          <li>
            <a className="url uid" href="https://www.youtube.com/SacStateVideo">
        ...
        <address
          className="col-md-4 order-md-3 adr text-light"
          translate="no"
